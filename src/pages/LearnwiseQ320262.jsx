...
export default function LearnwiseQ320262() {
    const gridItems = [
  ...
  >
    The Foundation to Deliver Results
        ...
        <div className="max-w-8xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[4px]">
          {gridItems.map((item) => (
            ...
            >
              ...
              <span
                ...
                text-[#cf5148]/40
                transition-all duration-500 ease-out
                group-hover:text-[#cf5148]/90 group-hover:scale-110
                group-hover:drop-shadow-[0_0_20px_#cf5148]"
              >
                {item.number}
              </span>
          ...
          {/* Chevron Navigation */}
          <ChevronNav prev="/learnwiseQ320261" next="/learnwiseQ320263" />
        </section>
      );
}
