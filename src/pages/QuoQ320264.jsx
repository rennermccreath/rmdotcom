...
export default function QuoQ320264() {
  return (
    <section
        ...
        >
          ...
          <div className="max-w-4xl w-full text-center mb-8">
            ...
            >
              <iframe
                src="https://www.loom.com/embed/2ddbe85b419e440c97dd0a81924a00d3?t=00hideEmbedTopBar=true&hide_share=true&hide_title=true&hide_owner=true"
                frameBorder="0"
                allowFullScreen
                loading="lazy"
          ...
          {/* Chevron Navigation */}
          <ChevronNav prev="/quoQ320263" next="/quoQ320261" />
        </section>
      );
}
