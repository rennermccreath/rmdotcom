...
export default function HootsuiteQ220263() {
  ...
  const timelineItems = [
    {
      ...
      content: (
        <div>
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 text-center text-[#E03035]/90">
          ...
          <ul className="text-base sm:text-lg md:text-xl text-[#E03035]/90 list-[square] list-inside space-y-2">
  ...
  return (
    ...
    >
      <ChevronNav prev="/hootsuiteq220262" next="/hootsuiteq220264" />
      ...
      <div className="hidden md:grid grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          {timelineItems.map((item) => (
            <div
              ...
              className={`
                ...
                text-[#E03035]/80 drop-shadow-[0_0_12px_#E03035]
                transition-all duration-500 ease-out
                hover:text-[#E03035]/90 hover:drop-shadow-[0_0_20px_#E03035] hover:scale-105
                animate-[gold-pulse_4s_ease-in-out_infinite]
                ${activeItem === item.id ? "scale-110 drop-shadow-[0_0_25px_#E03035]" : ""}
              `}
            >
        ...
        <div className="flex flex-col justify-center p-6 border-l border-[#E03035]/40 min-h-[400px] md:sticky md:top-24 self-start">
          {activeContent ? (
            <motion.div
              key={activeItem}
              ...
              className="bg-black/60 border border-white/10 p-8 shadow-lg drop-shadow-[0_0_12px_#E03035]"
            >
              {activeContent}
            </motion.div>
          ) : (
      ...
      {activeItem && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setActiveItem(null)}
              className="mt-6 px-4 py-2 bg-[#E03035] text-black font-semibold hover:bg-[#f5ff72] transition w-full rounded"
            >
              Close
            </button>
          </div>
