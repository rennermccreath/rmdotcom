...
export default function CaribouQ320263() {
  ...
  const timelineItems = [
    {
      ...
      content: (
        <div>
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 text-center text-[#ea2275]/90">
          ...
          <ul className="text-base sm:text-lg md:text-xl text-[#ea2275]/90 list-[square] list-inside space-y-2">
  ...
  return (
    ...
    >
      <ChevronNav prev="/caribouQ320262" next="/caribouQ320264" />
      ...
      <div className="hidden md:grid grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          {timelineItems.map((item) => (
            <div
              ...
              className={`
                ...
                text-[#ea2275]/80 drop-shadow-[0_0_12px_#ea2275]
                transition-all duration-500 ease-out
                hover:text-[#ea2275]/90 hover:drop-shadow-[0_0_20px_#ea2275] hover:scale-105
                animate-[gold-pulse_4s_ease-in-out_infinite]
                ${activeItem === item.id ? "scale-110 drop-shadow-[0_0_25px_#ea2275]" : ""}
              `}
            >
        ...
        <div className="flex flex-col justify-center p-6 border-l border-[#ea2275]/40 min-h-[400px] md:sticky md:top-24 self-start">
          {activeContent ? (
            <motion.div
              key={activeItem}
              ...
              className="bg-black/60 border border-white/10 p-8 shadow-lg drop-shadow-[0_0_12px_#ea2275]"
            >
              {activeContent}
            </motion.div>
          ) : (
      ...
      {activeItem && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setActiveItem(null)}
              className="mt-6 px-4 py-2 bg-[#ea2275] text-black font-semibold hover:bg-[#f85490] transition w-full rounded"
            >
              Close
            </button>
          </div>
