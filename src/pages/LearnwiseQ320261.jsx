...
export default function LearnwiseQ320261() {
  return (
    <section
        ...
        >
          ...
          <div className="max-w-4xl w-full text-center mb-8">
            ...
            >
              <iframe
                src="https://www.loom.com/embed/af1b261b47094b81ae1a60a09a8a028b?t=00hideEmbedTopBar=true&hide_share=true&hide_title=true&hide_owner=true"
                frameBorder="0"
                allowFullScreen
                loading="lazy"
          ...
          <motion.p
              ...
              transition={{ duration: 1, delay: 0.6, ease: "easeOut" }}
            >
              Candidate Presentation - Customer Success Manager
            </motion.p>
            

          {/* Chevron Navigation */}
          <ChevronNav next="/learnwiseQ320262" />
        </section>
      );
}
