...
export default function HootsuiteQ320262() {
    const gridItems = [
  ...
  >
    The Foundation to Deliver Results
        ...
        <div className="max-w-8xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[4px]">
          {gridItems.map((item) => (
            ...
            >
              ...
              <span
                ...
                text-[#E03035]/40
                transition-all duration-500 ease-out
                group-hover:text-[#E03035]/90 group-hover:scale-110
                group-hover:drop-shadow-[0_0_20px_#E03035]"
              >
                {item.number}
              </span>
          ...
          {/* Chevron Navigation */}
          <ChevronNav prev="/hootsuiteQ320261" next="/hootsuiteQ320263" />
        </section>
      );
}
