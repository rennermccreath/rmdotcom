...
export default function CoLabQ320262() {
  ...
  return (
    ...
    >
      <ChevronNav prev="/colabQ320261" next="/colabQ320263" />
      ...
      {activeItem && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setActiveItem(null)}
              className="mt-6 px-4 py-2 bg-[#c89116] text-black font-semibold hover:bg-[#f5ff72] transition w-full rounded"
            >
              Close
            </button>
          </div>
