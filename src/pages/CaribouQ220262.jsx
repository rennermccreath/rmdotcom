...
export default function CaribouQ220262() {
    const gridItems = [
  ...
  >
    The Foundation to Deliver Results
        ...
        <div className="max-w-8xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[4px]">
          {gridItems.map((item) => (
            ...
            >
              ...
              <span
                ...
                text-[#ea2275]/40
                transition-all duration-500 ease-out
                group-hover:text-[#ea2275]/90 group-hover:scale-110
                group-hover:drop-shadow-[0_0_20px_#ea2275]"
              >
                {item.number}
              </span>
          ...
          {/* Chevron Navigation */}
          <ChevronNav prev="/caribouq220261" next="/caribouq220263" />
        </section>
      );
}
