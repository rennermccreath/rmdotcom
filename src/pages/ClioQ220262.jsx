...
export default function ClioQ220262() {
    const gridItems = [
  ...
  >
    The Foundation to Deliver Results
        ...
        <div className="max-w-8xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[4px]">
          {gridItems.map((item) => (
            ...
            >
              ...
              <span
                ...
                text-[#008672]/40
                transition-all duration-500 ease-out
                group-hover:text-[#008672]/90 group-hover:scale-110
                group-hover:drop-shadow-[0_0_20px_#008672]"
              >
                {item.number}
              </span>
          ...
          {/* Chevron Navigation */}
          <ChevronNav prev="/clioq220261" next="/clioq220263" />
        </section>
      );
}
